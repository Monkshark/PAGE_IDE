...
The [Atlas](https://monkshark.github.io/page-ide/#internals/atlas/main_en.md) overview — modules laid out as cards you double-click to drill into — must look identical in the desktop IDE and in the browser docs viewer. `atlas-view` is that render and model pulled out of `page:atlas` into a multiplatform (`jvm`+`wasmJs`) module. The analyzer, IDE panels, and snapshot export stay in desktop `page:atlas`; only the view-facing parts come here. It uses shared-core's [FilePath](https://monkshark.github.io/page-ide/#internals/shared-core/main_en.md) instead of `java.nio.Path`.

> 한국어: [main.md](https://monkshark.github.io/page-ide/#internals/atlas-view/main.md)
...
- [See the Atlas module](https://monkshark.github.io/page-ide/#internals/atlas/main_en.md)
