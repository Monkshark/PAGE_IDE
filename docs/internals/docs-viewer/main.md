...
`java.*` 없이 [shared-core](https://monkshark.github.io/page-ide/#internals/shared-core/main.md) 의 파서·라우팅과 [atlas-view](https://monkshark.github.io/page-ide/#internals/atlas-view/main.md) 의 그래프를 그대로 조립한다.

> English: [main_en.md](https://monkshark.github.io/page-ide/#internals/docs-viewer/main_en.md)
...
- [shared-core 보기](https://monkshark.github.io/page-ide/#internals/shared-core/main.md)
