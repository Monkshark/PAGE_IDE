...
interface LspInstaller {
    ...
    fun versionGroups(versions: List<String>): List<VersionGroup>? = null
    ...
    fun uninstall(version: String) = uninstall(version) { _, _ -> }

    fun uninstall(version: String, onProgress: (removed: Int, total: Int) -> Unit) {
